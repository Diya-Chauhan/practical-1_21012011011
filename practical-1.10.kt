...
fun main() {
    ...
    val car1 = Car("BMW, 2018","Krima",105, 10000.0,98950.0)
    car1.displayCarInfo()
    println("Creating Car Class Object car2 in next line")
    val car2 = Car("BMW, 2019","Jeni",20, 400000.0,399800.0)
    car2.displayCarInfo()
    println("\n********** ArrayList of Car **********")
    val carlist = ArrayList<Car>()
    carlist.add(Car("Toyota, 2017","Meha",100,1080000.0,1079000.0))
    carlist.add(Car("Maruti, 2020","Rutvi",200,4000000.0,3998000.0))
